...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-b1y2nyiyv75t-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
async function translateText(params: TranslateParams): Promise<TranslationResult[]> {
  const response = await fetch(
    "https://app-b1y2nyiyv75t-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
