...
| Item | Value |
|------|-------|
| Endpoint | `POST https://app-b1y2nyiyv75t-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
// POST to: https://app-b1y2nyiyv75t-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent
