...
- **Endpoint**: `GET https://app-b1y2nyiyv75t-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart`
...
async function callWebSearch(
  ...
  const response = await fetch(
    `https://app-b1y2nyiyv75t-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart?${params.toString()}`,
    {
      method: "GET",
      headers: {
