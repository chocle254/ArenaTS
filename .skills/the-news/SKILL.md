...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-b1y2nyiyv75t-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-b1y2nyiyv75t-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-b1y2nyiyv75t-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-b1y2nyiyv75t-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-b1y2nyiyv75t-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-b1y2nyiyv75t-api-wL1zlEdVM6DY.gateway.appmedo.com`
