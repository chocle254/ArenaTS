...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-b1y2nyiyv75t-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl` |
...
async function ocrParseImageUrl(
  ...
  const response = await fetch(
    `https://app-b1y2nyiyv75t-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl?${params.toString()}`,
    {
      method: "GET",
      headers: {
